...
UPSET Header | FUNNY Header | ?BUSY Header?
------------ | ------------- | -------------
Your content can | be here, and it | can be here....
And here. | Okay. | I think we can get it.
...
ReactDOM.render( /*#__STAYSMARTWZ__*/React.createElement(App, null), document.getElementById('app'));